...
public class Machine_Furnace extends BlockContainer
{

	protected Machine_Furnace(Material materialIn)
	{
		super(materialIn);
	}
    /**
    ...
    protected Machine_Furnace(int par1, boolean par2)
    {
    ...
    {
        return mod_blocks.Machine_FurnaceIdle.blockID;
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, mod_blocks.Machine_FurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, mod_blocks.Machine_FurnaceIdle.blockID);
        }

package com.Mr_Galaxy.Subcraft_2.inventory;
...
public class container_furnace extends Container
{
    ...
    public container_furnace(InventoryPlayer par1InventoryPlayer, TileEntityFurnace par2TileEntityFurnace)
    {

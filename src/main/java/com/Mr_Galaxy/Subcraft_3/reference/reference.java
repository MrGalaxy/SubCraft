...
public class reference
{
    ...
    public static final String MOD_ID = "subcraft_3";
    public static final String MOD_NAME = "Subcraft 3";
    public static final String SERVER_PROXY_CLASS = "com.Mr_Galaxy.Subcraft_3.proxy.ComProxy";
